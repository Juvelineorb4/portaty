import {
  ...
  const CustomSearchSellerProduct = ({ route, navigation }) => {
    ...
    return (
      ...
      >
        <View style={styles.container}>
          ...
          <View style={styles.content}>
            <View style={styles.containerTitle}>
              ...
              {user?.attributes?.sub === product.product.customerID && (
                  ...
                  <View style={styles.leftAbout}>
                    {product.product.condition ? (
                      <View style={styles.about}>
                        ...
                        <Text style={styles.textAbout}>{product.product.condition}</Text>
                      </View>
                    ) : (
                      <View style={styles.about}>
                        <View style={styles.labelAbout}>
        ...
        >
          ...
          >
            Otros productos de {product.product.customer.name}
          </Text>
  ...
  export default CustomSearchSellerProduct;
